        ...
        <div className="mdl-card__supporting-text">
          <div className="mdl-grid">
            <div className="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet mdl-cell--2-col-phone">
              <Graph title={"Alugar"} value={rentValue} height={barHeights.rent} best={rentValue < installment} />
            </div>
            <div className="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet mdl-cell--2-col-phone">
              <Graph title={"Comprar"} value={installment} height={barHeights.buy} best={installment < rentValue} />
            </div>
          </div>
        </div>
      </section>
